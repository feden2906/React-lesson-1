    ...
    return (
        <div className="users">
            <div className="divForHommey">
                <User name={'Homer'} surname={'Simpson'} age={'40'}
            ...
            <div className="divForBartholomew">
                <User name={'Bart'} surname={'Simpson'} age={'10'}
            ...
            <div className="divForMarge">
                <User name={'Marge'} surname={'Simpson'} age={'38'}
